...
@section('3')
<li class="before:mx-2">Generation</li>
@endsection
...
<form action="{{ url('/generation') }}" method="get"
...
<a href="{{ route('generation.create') }}"><button type="button" class=" mt-6 text-white bg-cyan-500 hover:bg-cyan-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-cyan-500 dark:hover:bg-cyan-600 focus:outline-none dark:focus:ring-cyan-600">ADD GENERATION</button></a>
  ...
  <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50 ">
          ...
          <th scope="col" class="px-6 py-4 font-medium text-gray-900">S.NO</th>
            ...
            <th scope="col" class="px-6 py-4 font-medium text-gray-900">Generation</th>
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          ...
          <tr class="hover:bg-gray-50">
            ...
            <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
              <div class="relative h-16 w-16">
                <img
                  ...
                  src={{ asset('/images/gen/'.$item->generation_img) }}
                  alt=""
                />
            ...
            <td class="px-6 py-4">
              <div class="font-medium text-gray-400">{{ $item->generation_name}}</div>
            </td>
           
            <td class="pX-4 py-4">
              
              <form action="{{ route('generation.destroy',$item->id) }}" method="Post">
                <a href="{{ route('generation.edit',$item->id) }}">
      ...
      <div class="ml-6 mr-6">{!! $generations->links() !!}</div>
