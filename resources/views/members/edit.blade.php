...
@section('3')
<li class="before:mx-2">Edit Talent</li>
@endsection
...
<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-3 ">
    <div class="form-group">
        ...
        <input type="text" name="members_name" placeholder="members_name" value="{{ $member->members_name}}"
    ...
    <div class="form-group">
        ...
        <input type="text" name="members_nickname" placeholder="members_nickname" value="{{ $member->members_nickname }}"
        class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_greet" placeholder="members_greet" value="{{ $member->members_greet }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      @error('members_greet')
        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_debutdate" placeholder="members_debutdate" value="{{ $member->members_debutdate }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_name_Illustrator" placeholder="members_name_Illustrator" value="{{ $member->members_name_Illustrator }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_youtube_name" placeholder="members_youtube_name" value="{{ $member->members_youtube }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <textarea type="textarea" name="members_title" placeholder="members_title" value="{{ $member->members_title }}"
  ...
  <div class="form-group">
      ...
      <textarea type="textarea" name="members_profile" placeholder="members_profile" value="{{ $member->members_profile }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
    ...
    <div class="form-group"> 
      ...
      <textarea type="textarea" name="members_personality" placeholder="members_personality" value="{{ $member->members_personality }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
...
<option value="{{$key}}" {{($key == $member->generation_id) ? 'selected' : ''}}>
    {{$value}}
</option>
@endforeach
...
<option value="{{$key}}" {{($key == $member->affiliation_id) ? 'selected' : ''}}>
  {{$value}}
</option>
@endforeach
...
@enderror
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_introduction_video" placeholder="members_introduction_video"  value="{{ $member->members_introduction_video }}" 
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="text" name="members_youtube" placeholder="members_youtube" value="{{ $member->members_youtube }}" 
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
  ...
  <div class="form-group">
    ...
    <input type="text" name="ch" placeholder="ch" value="{{ $member->ch }}"
    class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    @error('ch')
    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
    @enderror
    ...
    <div class="form-group">
      ...
      <input type="file" name="members_img_icon" placeholder="members_img_icon" value="{{ $member->members_img_icon }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="file" name="members_img_costume" placeholder="members_img_costume" value="{{ $member->members_img_costume }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="file" name="members_img_costume2" placeholder="members_img_costume2" value="{{ $member->members_img_costume2 }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="file" name="members_img_artwork" placeholder="members_img_artwork" value="{{ $member->members_img_artwork }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
    ...
    <div class="form-group">
      ...
      <input type="file" name="members_img_concept" placeholder="members_img_concept" value="{{ $member->members_img_concept }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
