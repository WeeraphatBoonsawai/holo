...
@section('3')
<li class="before:mx-2">Edit MUSIC</li>
@endsection
...
<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-3 ">
    <div class="form-group">
        ...
        <input type="text" name="music_name" placeholder="music_name" value="{{ $music->music_name}}"
    ...
    <div class="form-group">
        ...
        <input type="text" name="music_link" placeholder="music_link" value="{{ $music->music_link }}"
        class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
        @error('music_link')
        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group">
      ...
      <input type="text" name="ch" placeholder="ch" value="{{ $music->ch }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      @error('ch')
        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
        @enderror
    ...
    <div class="form-group">
      ...
      <input type="text" name="music_img" placeholder="music_img" value="{{ $music->music_img }}"
      class="form-control block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
      @error('music_img')
      <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
      @enderror
