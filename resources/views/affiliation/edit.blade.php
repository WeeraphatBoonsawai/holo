...
@section('3')
<li class="before:mx-2">Edit Affiliation</li>
@endsection
...
<h1 class="text-xl font-bold text-black capitalize dark:text-black">Affiliation</h1>
...
<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-3 ">
    <div class="form-group">
        ...
        <input type="text" name="affiliation_name" placeholder="affiliation_name" value="{{ $affiliation->affiliation_name}}"
